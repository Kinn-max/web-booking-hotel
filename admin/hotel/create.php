...
if (isset($_POST['submit'])) {
    ...
    // Xử lý slug (chuỗi để gắn vào URL - có thể tạo tự động từ tên khách sạn)
    $slug = strtolower(trim(preg_replace('/[^A-Za-z0-9-]+/', '-', $name), '-'));

    // Kiểm tra xem khách sạn với tên và địa chỉ đã tồn tại chưa
    ...
    if (mysqli_num_rows($check_result) > 0) {
        // Nếu đã tồn tại khách sạn với tên và địa chỉ này
        $error_message = 'Khách sạn đã tồn tại!';
    } else {
        // Xử lý upload ảnh
...
<div class="both-item">
    <div class="category">
        ...
        <ul class="category_list">
            <a href="../index.php?page=hotel" class="text-category">
            ...
            <a href="../index.php?page=city" class="text-category">
                <li class="category_list-item menu_ts">
                    <div class="show_category-both">
                        <div class="both_icon">
                            <i class="fa-solid fa-layer-group"></i>
    ...
    <div class="city-management-container">
        ...
        <form method="post" enctype="multipart/form-data" id="createHotel">
            <label>Tên khách sạn</label>
            <input type="text" id="name" name="name" value="" placeholder="Nhập tên khách sạn" required>

            <label>Địa chỉ</label>
            <input type="text" id="address" name="address" value="" placeholder="Địa chỉ khách sạn" required>

            <label>Số điện thoại</label>
            <input type="text" id="phone" name="phone" value="" placeholder="Số điện thoại" required>

            <label>Mô tả</label>
            <textarea id="description" name="description" placeholder="Mô tả khách sạn"></textarea>

            <label>Thuộc thành phố</label>
            <select id="option" name="city" id="city">
                <?php while ($rowCity = $result->fetch_assoc()){?>
            ...
            <!-- Phần xem trước hình ảnh đã chọn -->
...
<!-- Thêm JavaScript để xử lý hiển thị ảnh xem trước -->
<script>
        ...
        if (files) {
            for (var i = 0; i < files.length; i++) {
                ...
                reader.onload = function(e) {
                    ...
                    img.style.maxWidth = '150px'; // Cài đặt kích thước ảnh xem trước
