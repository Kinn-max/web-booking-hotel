...
<head>
    ...
    <style>
        ...
        .thumbnail {
            width: 100%; /* Đặt chiều rộng hình ảnh 100% */
            height: auto; /* Giữ tỉ lệ của hình ảnh */
            max-width: 150px; /* Đặt chiều rộng tối đa cho hình ảnh */
            max-height: 100px; /* Đặt chiều cao tối đa cho hình ảnh */
            object-fit: cover; /* Cắt và giữ tỉ lệ hình ảnh nếu cần */
        }
...
<div class="city-management-container">
    <h2 style="display: flex; align-items: center;">
        <a href="../index.php?page=hotel" style="margin-right: 30%"><button class="back">trở về</button></a>
        Chi tiết khách sạn
    </h2>
...
<table>
    ...
    <?php
        ...
        <tr>
            ...
            <td>
                <a href="delete.php?this_id=<?php echo $row['id']; ?>"><button class="delete" onclick="return confirm('Có chắc xóa thành phố này không?');">Xóa</button></a>
                <a href="update.php?this_id=<?php echo $row['id']; ?>"><button class="edit">Sửa</button></a>
            </td>
        </tr>
</table>
</div>
    ...
    <script>
        ...
        for (let i = 0; i < images.length; i++) {
            images[i].onclick = function(){
                ...
                captionText.innerHTML = this.alt; // Hiển thị mô tả nếu cần
            }
        }
