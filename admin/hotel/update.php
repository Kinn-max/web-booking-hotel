...
$sql = "SELECT * FROM `hotel` WHERE id = '$this_id'";
$result = mysqli_query($mysqli, $sql);
$row = mysqli_fetch_array($result);

//Truy vấn dữ liệu city
$id_city = $row['id_city'];
$id_cityData = "SELECT * FROM city WHERE id = '$id_city'";
$id_cityResult = $mysqli->query($id_cityData);
$id_cityRow = mysqli_fetch_array($id_cityResult);

$city = "SELECT id, name FROM city WHERE id NOT IN (SELECT id_city FROM hotel WHERE id = '$this_id')";
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE hotel SET id_city = '$id_city', name = '$name', address = '$address', phone = '$phone', description = '$description' 
             WHERE id = " . $this_id;
    ...
    if (!empty($image_files)) {
        // Xóa ảnh cũ (nếu có) khỏi bảng image_hotel
        $delete_sql = "DELETE FROM image_hotel WHERE id_hotel = '$this_id'";
        ...
        foreach ($_FILES['image']['name'] as $key => $image_name) {
            ...
            // Thêm ảnh vào bảng image_hotel
            $image_sql = "INSERT INTO image_hotel (id_hotel, name) VALUES ('$this_id', '$image_path')";
...
<head>
    <title>Form sửa khách sạn</title>
...
<div class="form-container">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <select id="option" name="city" id="city">
            <option value="<?php echo $id_cityRow['id']?>"><?php echo $id_cityRow['name']?></option>
        ...
        <div class="image-preview">
            <?php foreach ($images as $image) { ?>
                <div class="image-container">
                    <img src="<?php echo "../../images/hotel-detail/" . $image ?>" alt="Hotel Image" />
                </div>
            <?php } ?>
        </div>
